...
namespace FreightAccounting.Core.Migrations
{
    ...
    [Migration("20230904195713_AddedBoolToRemittance")]
    partial class AddedBoolToRemittance
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FreightAccounting.Core.Entities.Remittance", b =>
                {
                    ...
                    b.Property<bool>("IsUserCutEnteredByHand")
                        .HasColumnType("bit");
                    ...
                    b.Property<long>("ProductInsurancePayment")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FreightAccounting.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            NameAndFamily = "kaveh",
                            Password = "c65b991200134687b346c16d9d32c9ad2112045b1f7b36038f63b6ca09f34164",
                            Username = "kaveh"
                        });
                });
